...
/* 
+-----------------------------------------------------------------------*/
void semaphore_wait_Launch(void) {
  if(sem_wait(&semLaunch) != 0){
...
/* 
+-----------------------------------------------------------------------*/
void semaphore_post_Launch(void) {
  if(sem_post(&semLaunch) != 0){
...
/* 
+-----------------------------------------------------------------------*/
void semaphore_wait_Catch(void) {
  if(sem_wait(&semCatch) != 0){
    fprintf(stderr, "Error in sem_post()\n");
    exit(EXIT_FAILURE);
  }
}
...
/* 
+-----------------------------------------------------------------------*/
void semaphore_post_Catch(void) {
  if(sem_post(&semCatch) != 0){
    fprintf(stderr, "Error in sem_post()\n");
    exit(EXIT_FAILURE);
  }
}
...
int main (int argc, char** argv) {
    ...
    if(sem_init(&semLaunch, 0, MAXPAR) != 0){
      fprintf(stderr, "Error creating semaphore.\n");
      exit(EXIT_FAILURE);
    }

    if(sem_init(&semCatch, 0, 0) != 0){
      fprintf(stderr, "Error creating semaphore.\n");
      exit(EXIT_FAILURE);
    }
    ...
    sem_destroy(&semLaunch);
    sem_destroy(&semCatch);
